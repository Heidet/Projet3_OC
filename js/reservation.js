...
var stations = {
	...
	recupAllStations : function() {
		var urlRequete = `https://api.jcdecaux.com/vls/v1/stations?contract=${this.contractName}&apiKey=${this.apiKey}`;
	...
	stationSelected : function (station) {
		...
		var urlStation = `https://api.jcdecaux.com/vls/v1/stations?contract=${this.contractName}&apiKey=${this.apiKey}`;
...
var currentStation = {
	...
	init: function (source) {
		...
		// Vérificatiob du vélo décrementé
